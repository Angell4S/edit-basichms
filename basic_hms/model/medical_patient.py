...
class medical_patient(models.Model):
    ...
    def print_report(self):
        return self.env.ref(
            'basic_hms.report_print_patient_card'
        ).report_action(self)
    ...
    def onchange_age(self):
        for rec in self:
            if rec.date_of_birth:
                ...
                rec.age = "Coloque año de nacimiento!!"
    ...
    date_of_birth = fields.Date(string="Año de nacimiento")
    sex = fields.Selection(
        [('m', 'Masculino'), ('f', 'Femenino')], string="Sexo"
    )
    age = fields.Char(
        compute=onchange_age, string="Edad del paciente", store=True
    )
    critical_info = fields.Text(string="Motivo de consulta")
    ...
    sedentarismo = fields.Boolean(string="Sedentarismo")
    sueno = fields.Boolean(string="Sueño")
    activo = fields.Boolean(string="Activo")
    muy_activo = fields.Boolean(string="Muy Activo")
    deporte = fields.Boolean(string="Deporte")
    tabaco = fields.Boolean(string="Tabaco")
    alcohol = fields.Boolean(string="Alcohol")
    ansiedad = fields.Boolean(string="Ansiedad")
    nerviosismo = fields.Boolean(string="Nerviosismo")
    stress = fields.Boolean(string="Stress")
    exps_solar = fields.Boolean(string="Exps. Solar")
    otros = fields.Boolean(string="Otros")

    enf_pad = fields.Text(string="Enfermedades Padecidas")
    enf_act = fields.Text(string="Enfermedades Actuales")
    medicacion_habi = fields.Text(string="Medicación Habitual")
    alergias = fields.Text(string="Alergias")
    protesis_act = fields.Text(string="Prótesis Actuales")

    blefarosplastia = fields.Boolean(string="Blefaroplastia")
    rinoplastia = fields.Boolean(string="Rinoplastia")
    lifting = fields.Boolean(string="Lifting")

    dermapen = fields.Boolean(string="Dermapen")
    despigmentacion = fields.Boolean(string="Despigmentación")
    colageno = fields.Boolean(string="Colágeno")
    biopolomeros = fields.Boolean(string="Biopolímeros")
    prp = fields.Boolean(string="PRP")
    toxina_botu = fields.Boolean(string="Toxina Botulínica")
    hilos = fields.Boolean(string="Hilos")
    acido_hialu = fields.Boolean(string="Ácido Hialurónico")
    laser = fields.Boolean(string="Láser")

    tipo_relleno = fields.Selection(
        [('si', 'SI'), ('no', 'NO'), ('nose', 'NO SÉ')],
        "¿TE HAS APLICADO ALGÚN TIPO DE RELLENO PERMANENTE?",
    )

    historia_paciente = fields.Char()
    tratamiento_paciente = fields.Char(string="Tratamiento de paciente")
    fecha_trat_paciente = fields.Date(string="fecha del tratamiento")
